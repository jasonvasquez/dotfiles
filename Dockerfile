...
RUN \
  mkdir t && \
  cd t && \
  curl --silent -LO https://github.com/github/git-lfs/releases/download/v1.0.2/git-lfs-linux-amd64-1.0.2.tar.gz && \
...
# ohmyzsh ==============================================
# Adding 'true' to the end, this thing exits non-zero for some reason even when it works
